                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, full) {
                            ...
                            let $actions = '<span class="action-delete text-danger pe-1 cursor-pointer" data-id=' + full['delete'] + '>' +
                            ...
                            if (full['get_status'] === 'pending') {
                                $actions += '<span class="action-approve text-warning cursor-pointer" data-bs-toggle="tooltip" data-placement="top" title="' + full['status_locale'] + '" data-id=' + full['uid'] + '>' +

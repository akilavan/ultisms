                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if($server['settings'] == 'msg91' || $server['settings'] == 'CyberGateLK' || $server['settings'] == \App\Models\SendingServer::TYPE_ROUNDSMS || $server['settings'] == \App\Models\SendingServer::TYPE_ALLMYSMS)
                                        ...
                                        @if($server['settings'] == \App\Models\SendingServer::TYPE_ROUNDSMS)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] ==  \App\Models\SendingServer::TYPE_GUPSHUPIO)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == 'MidasAppBr')
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="c2">Template 1</label>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label class="form-label required" for="c3">Template 2</label>
                                        ...
                                        @if($server['settings'] == 'GatewaySa' || $server['settings'] == 'SendPulse' || $server['settings'] == \App\Models\SendingServer::TYPE_DIGINTRA)
                                        ...
                                        @if($server['settings'] == 'ClickatellCentral' || $server['settings'] == 'RouteMobile' || $server['settings'] == 'SMSGlobal' || $server['settings'] == 'BulkSMS' ||  $server['settings'] == '1s2u' || $server['settings'] == 'SMPP' || $server['settings'] == 'HutchLk' || $server['settings'] == 'Teletopiasms' || $server['settings'] == 'Solutions4mobiles' || $server['settings'] == 'BulkSMSOnline' || $server['settings'] == 'EasySendSMS' || $server['settings'] == 'AfricasTalking' || $server['settings'] == 'KeccelSMS' || $server['settings'] == 'Text2World' || $server['settings'] == 'LTR' || $server['settings'] == 'D7Networks' || $server['settings'] == 'Solucoesdigitais' || $server['settings'] == 'BongaTech' || $server['settings'] == 'Ejoin' || $server['settings'] == 'SendSMSGate' || $server['settings'] == 'SMSCarrierEU' || $server['settings'] == 'VisionUp' || $server['settings'] == 'SMSVas' || $server['settings'] == 'CCSSMS' || $server['settings'] == \App\Models\SendingServer::TYPE_SAFARICOM || $server['settings'] == \App\Models\SendingServer::TYPE_FACILITAMOVEL || $server['settings'] == \App\Models\SendingServer::TYPE_SMSDELIVERER || $server['settings'] == \App\Models\SendingServer::TYPE_YOSMS || $server['settings'] == \App\Models\SendingServer::TYPE_ESOLUTIONS || $server['settings'] == \App\Models\SendingServer::TYPE_ESTORESMS || $server['settings'] == \App\Models\SendingServer::TYPE_GOIP || $server['settings'] == \App\Models\SendingServer::TYPE_ADVANCEMSGSYS)
                                        ...
                                        @if($server['settings'] == \App\Models\SendingServer::TYPE_SAFARICOM)
                                            <div class="col-12">
                                                <div class="mb-1">
                                        ...
                                        @if($server['settings'] == \App\Models\SendingServer::TYPE_UIPAPP)
                                            <div class="col-12">
                                                <div class="mb-1">

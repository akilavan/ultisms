                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if($server['settings'] == 'ClickatellCentral' || $server['settings'] == 'RouteMobile' || $server['settings'] == 'SMSGlobal' || $server['settings'] == 'BulkSMS' ||  $server['settings'] == '1s2u' || $server['settings'] == 'SMPP' || $server['settings'] == 'HutchLk' || $server['settings'] == 'Teletopiasms' || $server['settings'] == 'Solutions4mobiles' || $server['settings'] == 'BulkSMSOnline' || $server['settings'] == 'EasySendSMS' || $server['settings'] == 'AfricasTalking' || $server['settings'] == 'KeccelSMS' || $server['settings'] == 'Text2World' || $server['settings'] == 'LTR' || $server['settings'] == 'D7Networks' || $server['settings'] == 'Solucoesdigitais' || $server['settings'] == 'BongaTech' || $server['settings'] == 'Ejoin' || $server['settings'] == 'SendSMSGate' || $server['settings'] == 'SMSCarrierEU' || $server['settings'] == 'VisionUp' || $server['settings'] == 'SMSVas' || $server['settings'] == 'CCSSMS' || $server['settings'] == 'Safaricom' || $server['settings'] == \App\Models\SendingServer::TYPE_FACILITAMOVEL || $server['settings'] == \App\Models\SendingServer::TYPE_SMSDELIVERER || $server['settings'] == \App\Models\SendingServer::TYPE_YOSMS|| $server['settings'] == \App\Models\SendingServer::TYPE_ESOLUTIONS || $server['settings'] == \App\Models\SendingServer::TYPE_ESTORESMS || $server['settings'] == \App\Models\SendingServer::TYPE_GOIP || $server['settings'] == \App\Models\SendingServer::TYPE_ADVANCEMSGSYS)
                                        ...
                                        @if($server['settings'] == 'MidasAppBr')
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="c3" class="form-control @error('c3') is-invalid @enderror" value="{{ $server['c3'] }}" name="c3" required>
                                                    @error('c3')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
